    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='custom_users_groups', to='auth.group', verbose_name='guruhlar')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='custom_users_permissions', to='auth.permission', verbose_name='foydalanuvchi ruxsatlari')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_news.category', verbose_name='Yangilik kategoriyasi')),
            ],
            options={
                'verbose_name': 'News',
